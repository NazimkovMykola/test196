...
function handleKeyPress(event){
    ...
    if (key === "ArrowLeft"){
        ...
        if(shootCount > 0){
            ...
            alert("You are out of shoots, press 'arrow dawn' for reload.")  
        }
    }
    else if(key === "ArrowDown"){
        alert("You are reload 5 count.")    
        shootCount = 5
    }
}
...
function startGame(){
    ...
    for(let i = 0; i < ufosCount; i++){
        ...
        image.src = imageName;
        image.className = "ufo";
        console.log(image, imageContainer, imageContainer2)
        imageContainer.appendChild(image.cloneNode());
        imageContainer2.appendChild(image.cloneNode());
